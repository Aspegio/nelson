...
**The synthesis boundary:** Coordination means issuing orders, tracking progress, resolving blockers, and running checkpoints. **Synthesis work** (combining ship reports, summarising findings, recombining completed ship outputs into the final deliverable) is permitted for the admiral **only once all ships have reported successful completion with no open blockers or unresolved failures**.
...
- Battle plan assigns substantial generative synthesis to the admiral rather than a captain.
