...
| Role | Abbr | Function | agent_type | When to Crew |
|---|---|---|---|---|
| Executive Officer | XO | Integration & orchestration across sub-tasks | worker | 3+ crew or interdependent sub-tasks |
| Principal Warfare Officer | PWO | Core implementation work | worker | Almost always (default doer) |
| Navigating Officer | NO | Codebase research & exploration | explorer | Unfamiliar code, large codebase |
| Marine Engineering Officer | MEO | Testing & validation | worker | Station 1+ or non-trivial verification |
| Weapon Engineering Officer | WEO | Config, infrastructure, systems integration | worker | Significant config or infrastructure work |
| Logistics Officer | LOGO | Documentation & dependency management | worker | Docs as deliverable, dependency management |
| Coxswain | COX | Standards review & quality enforcement | explorer | Station 1+ with established conventions |
